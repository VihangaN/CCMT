  ...
  <v-app id="inspire">
    ...
    <v-dialog v-model="dialog" persistent max-width="290">
      <v-card id="card">
        ...
        <v-card-text>
          All your uploaded files and calculations are may lost.
          <br />please confirm
        </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
      ...
      <v-list dense nav link>
        ...
        <v-list-item id="upload">
          <v-list-item-content id="lic">
            ...
            <v-btn class="ma-2 white--text" color="#000" id="button-upload" @click="upload">
              Upload
...
#button-upload {
  ...
  background-image: linear-gradient(10deg, #23c5da 0%, #5772a5 100%) !important;
}
